...
#| fig-cap: !expr sprintf("Product problems representing approximately 80%% of problem occurrences (%s%%), plus 'Other(s)' category", pct_80)
#| fig-width: 8
...
#| fig-cap: !expr sprintf("Patient problems representing approximately 80%% of problem occurrences (%s%%), plus 'Other(s)' category", pct_80_patient)
#| fig-width: 8
...
#| fig-cap: !expr sprintf("Manufacturers representing approximately 80%% of reports (%s%%), plus 'Other(s)' category", pct_80_manufacturer)
#| fig-width: 8
...
```{{r brand-plot}}
#| label: fig-brands
#| fig-cap: !expr sprintf("Device brands representing approximately 80%% of reports (%s%%), plus 'Other(s)' category", pct_80_brand)
#| fig-width: 10
