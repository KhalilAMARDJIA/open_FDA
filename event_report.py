...
def run_analysis_with_report(data_path: str = Config.DATA_PATH):
    ...
    print("="*60)
    print(f"\nTo render the PDF report (medstata-typst), run:")
    ...
    print("\n" + "="*60)
    print("NOTE: Rendering requires:")
    print("  - Quarto installed")
    print("  - R packages: tidyverse, scales, knitr, lubridate")
    print("  - Install R packages with: install.packages(c('tidyverse', 'scales', 'knitr', 'lubridate'))")
    print("="*60 + "\n")
