...
**Search Query**: Acrysof IQ

**OpenFDA Database**: event

**API Endpoint**: https://api.fda.gov/device/event.json

**Search Executed**: 2025-11-20 14:59:44

**Data Last Updated**: 2025-11-11

**Total Results**: 15,345 records found in OpenFDA database

**Records Retrieved**: 15,345 records

**Records Analyzed**: 12,814 records (after data cleaning)
...
- **Generated**: 2025-11-20 14:59:48
- **Dataset Version**: 2025-10-31
- **Total Records Analyzed**: 12,814
